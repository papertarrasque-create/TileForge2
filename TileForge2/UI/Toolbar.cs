...
public class Toolbar
{
    ...
    private static readonly Color ButtonDisabledColor = new(45, 45, 45);
    private static readonly Color IconColor = new(200, 200, 200);
    private static readonly Color IconDimColor = new(80, 80, 80);
    private static readonly Color DimTextColor = new(120, 120, 120);
