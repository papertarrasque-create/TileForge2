...
{
    private static readonly Color BackgroundColor = new(20, 20, 20);
    private static readonly Color HeaderColor = new(40, 40, 40);
    private static readonly Color GridColor = new(255, 255, 255, 40);
    private static readonly Color SelectionFill = new(100, 160, 255, 80);
    private static readonly Color SelectionBorder = new(100, 160, 255, 200);
    private static readonly Color HintColor = new(120, 120, 120);
    private static readonly Color TypeActiveColor = new(70, 90, 130);
    private static readonly Color TypeInactiveColor = new(55, 55, 55);

    private const int HeaderBaseHeight = 32;
    private int _headerHeight = HeaderBaseHeight;
    private const int TypeButtonWidth = 60;
    ...
    public void CenterOnSheet(SpriteSheet sheet, Rectangle bounds)
    {
                     ...
                     Renderer renderer, Rectangle bounds, GameTime gameTime)
    {
        ...
        int typeX = bounds.X + 220;
        int typeY = bounds.Y + 4;
        _tileButtonRect = new Rectangle(typeX, typeY, TypeButtonWidth, 24);
        _entityButtonRect = new Rectangle(typeX + TypeButtonWidth + 4, typeY, TypeButtonWidth, 24);
        int propX = _entityButtonRect.Right + 12;
        _solidButtonRect = new Rectangle(propX, typeY, TypeButtonWidth, 24);
        _playerButtonRect = new Rectangle(propX + TypeButtonWidth + 4, typeY, TypeButtonWidth, 24);
        ...
        // Name field
        var nameRect = new Rectangle(bounds.X + 8, bounds.Y + 4, 200, 24);
