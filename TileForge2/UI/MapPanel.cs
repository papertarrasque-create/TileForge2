...
public class MapPanel : Panel
{
    ...
    public override int PreferredHeight => 200;

    // Colors
    private static readonly Color LayerHeaderBg = new(50, 50, 50);
    private static readonly Color LayerHeaderActiveBg = new(55, 70, 95);
    private static readonly Color LayerHeaderHoverBg = new(58, 58, 58);
    private static readonly Color GroupItemBg = new(42, 42, 42);
    private static readonly Color GroupSelectedBg = new(60, 80, 120);
    private static readonly Color GroupHoverBg = new(50, 55, 65);
    private static readonly Color LabelColor = new(200, 200, 200);
    private static readonly Color DimLabelColor = new(120, 120, 120);
    private static readonly Color VisibleColor = new(180, 200, 180);
    private static readonly Color HiddenColor = new(100, 70, 70);
    private static readonly Color ArrowColor = new(140, 140, 140);
    private static readonly Color BadgeColor = new(100, 100, 100);
    private static readonly Color AddButtonBg = new(50, 60, 50);
    private static readonly Color AddButtonHoverBg = new(60, 72, 60);
    private static readonly Color HeaderTextColor = new(180, 180, 180);
    private static readonly Color DragIndicatorColor = new(100, 160, 255);

    // Layout constants
    private const int LayerHeaderHeight = 28;
    private const int GroupItemHeight = 36;
    private const int ItemPadding = 2;
    private const int GroupIndent = 16;
    private const int PreviewSize = 24;
    private const int VisibilitySize = 12;
    private const int ArrowAreaWidth = 20;
    private const int VisibilityPadding = 8;
    private const int AddGroupButtonHeight = 22;
    private const int AddLayerButtonHeight = 24;
