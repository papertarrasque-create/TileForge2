...
public class StatusBar
{
                     ...
                     Renderer renderer, MapCanvas canvas, int screenWidth, int screenHeight)
    {
        ...
        string right = state.Clipboard != null
            ? "[Esc] clear stamp  [G]rid  Ctrl+M minimap  Ctrl+E export  Ctrl+S save"
            : "[M] select  [I] pick  [G]rid  Ctrl+M minimap  Ctrl+E export  Ctrl+C/V  Ctrl+Z/Y  Ctrl+S save";
